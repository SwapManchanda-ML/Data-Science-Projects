...
from rl2020.exercise4.n_step_implementation_folder.train_nstep_actor_critic import (
    CARTPOLE_CONFIG as REINFORCE_CARTPOLE_CONFIG,
)
from rl2020.exercise4.n_step_implementation_folder.train_nstep_actor_critic import (
    LUNARLANDER_CONFIG as REINFORCE_LUNARLANDER_CONFIG,
)
from rl2020.exercise4.n_step_implementation_folder.train_nstep_actor_critic import train as reinforce_train
...
CARTPOLE_CONFIGS = [
    ...
    (REINFORCE_CARTPOLE_CONFIG, "100-step Actor Ctitic", reinforce_train),
]

LUNARLANDER_TIMESTEPS = 1e6 #500000
LUNARLANDER_CONFIGS = [
    
    (REINFORCE_LUNARLANDER_CONFIG, "10-step Actor Ctitic", reinforce_train),
]
